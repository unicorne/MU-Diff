...
class NCSNpp(nn.Module):
    ...
    def forward(self, x, cond1, cond2, time_cond, z):
        # timestep/noise_level embedding; only for continuous training
        ...
        hs = [torch.cat((x_feat, cond1_feat, cond2_feat), axis=1)]
...
class NCSNpp_adaptive(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.feat_att1_c12 = conv3x3(2*nf,nf)
        self.feat_att2_c12 = conv3x3(2*nf,nf)

        # self.feat_att1_c21 = conv3x3(2*nf,nf)
        # self.feat_att2_c21 = conv3x3(2*nf,nf)
    ...
    def forward(self, x, cond1, cond2, time_cond, z, pseudo_target):
        # timestep/noise_level embedding; only for continuous training
        ...
        hs = [torch.cat((x_feat, fused_cond12), axis=1)]
